    ...
    <footer className="bg-white border-t border-pink-light py-10">
      <div className="max-w-7xl mx-auto px-6 flex flex-col items-center gap-8">
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span
            className="text-pink-deep text-2xl"
        ...
        <div className="grid sm:grid-cols-3 gap-6 text-center w-full max-w-2xl">
          <div className="flex flex-col items-center gap-1">
            ...
            <a
              href="tel:3343491193"
              className="font-sans text-sm text-gray-600 hover:text-pink-brand transition-colors"
            >
              334-349-1193
            </a>
          </div>
        ...
        <div className="flex flex-col items-center gap-3">
          ...
          <div className="flex gap-4">
            <a
              ...
              className="text-pink-brand hover:text-pink-deep transition-colors"
            >
              <InstagramIcon className="w-5 h-5" />
            </a>
            <a
              href="mailto:hello@lavishsacredbuns.com"
              aria-label="Email"
              className="text-pink-brand hover:text-pink-deep transition-colors"
            >
